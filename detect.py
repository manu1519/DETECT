...
def run(
        ...
        source=ROOT / r'C:\Users\Manuel\Desktop\Imagenes_30Metros\TITI\CIMA',  # file/dir/URL/glob/screen/0(webcam)
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=r'C:\Users\Manuel\Desktop\Imagenes_30Metros\TITI\yolov5\IMA3\Sal.mp4', help='file/dir/URL/glob/screen/0(webcam)')
